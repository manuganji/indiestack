...
declare module "zapatos/schema" {
	...
	export namespace public {
		...
		export type Selectable =
			| accounts.Selectable
			| block_list.Selectable
			| pgmigrations.Selectable
			| properties.Selectable
			| sessions.Selectable
			| users.Selectable
			| verification_tokens.Selectable;
		export type JSONSelectable =
			| accounts.JSONSelectable
			| block_list.JSONSelectable
			| pgmigrations.JSONSelectable
			| properties.JSONSelectable
			| sessions.JSONSelectable
			| users.JSONSelectable
			| verification_tokens.JSONSelectable;
		export type Whereable =
			| accounts.Whereable
			| block_list.Whereable
			| pgmigrations.Whereable
			| properties.Whereable
			| sessions.Whereable
			| users.Whereable
			| verification_tokens.Whereable;
		export type Insertable =
			| accounts.Insertable
			| block_list.Insertable
			| pgmigrations.Insertable
			| properties.Insertable
			| sessions.Insertable
			| users.Insertable
			| verification_tokens.Insertable;
		export type Updatable =
			| accounts.Updatable
			| block_list.Updatable
			| pgmigrations.Updatable
			| properties.Updatable
			| sessions.Updatable
			| users.Updatable
			| verification_tokens.Updatable;
		export type UniqueIndex =
			| accounts.UniqueIndex
			| block_list.UniqueIndex
			| pgmigrations.UniqueIndex
			| properties.UniqueIndex
			| sessions.UniqueIndex
			| users.UniqueIndex
			| verification_tokens.UniqueIndex;
		export type Column =
			| accounts.Column
			| block_list.Column
			| pgmigrations.Column
