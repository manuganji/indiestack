...
declare module 'zapatos/schema' {
  ...
  export namespace accounts {
    ...
    export interface Whereable {
      ...
      * - `NOT NULL`, no default
      */
      property_id?: string | db.Parameter<string> | db.SQLFragment | db.ParentColumn | db.SQLFragment<any, string | db.Parameter<string> | db.SQLFragment | db.ParentColumn>;
      /**
      * **accounts.user_id**
      * - `uuid` in database
      * - `NOT NULL`, no default
    ...
    export interface Insertable {
      ...
      * - `NOT NULL`, no default
      */
      property_id: string | db.Parameter<string> | db.SQLFragment;
      /**
      * **accounts.user_id**
      * - `uuid` in database
      * - `NOT NULL`, no default
    ...
    export interface Updatable {
      ...
      * - `NOT NULL`, no default
      */
      property_id?: string | db.Parameter<string> | db.SQLFragment | db.SQLFragment<any, string | db.Parameter<string> | db.SQLFragment>;
      /**
      * **accounts.user_id**
      * - `uuid` in database
      * - `NOT NULL`, no default
  ...
  export namespace properties {
    ...
    export type UniqueIndex = 'properties_pkey' | 'properties_uniq_id_domain';
    export type Column = keyof Selectable;
    export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
    export type SQLExpression = Table | db.ColumnNames<Updatable | (keyof Updatable)[]> | db.ColumnValues<Updatable> | Whereable | Column | db.ParentColumn | db.GenericSQLExpression;
    export type SQL = SQLExpression | SQLExpression[];
  ...
  export namespace sessions {
    ...
    export interface JSONSelectable {
      ...
      * - Nullable, no default
      */
      expires: db.TimestampTzString | null;
      /**
      * **sessions.session_token**
      * - `uuid` in database
      * - `NOT NULL`, default: `gen_random_uuid()`
    ...
    export interface Insertable {
      ...
      * - Nullable, no default
      */
      expires?: (db.TimestampTzString | Date) | db.Parameter<(db.TimestampTzString | Date)> | null | db.DefaultType | db.SQLFragment;
      /**
      * **sessions.session_token**
      * - `uuid` in database
      * - `NOT NULL`, default: `gen_random_uuid()`
    ...
    export interface Updatable {
      ...
      * - Nullable, no default
      */
      expires?: (db.TimestampTzString | Date) | db.Parameter<(db.TimestampTzString | Date)> | null | db.DefaultType | db.SQLFragment | db.SQLFragment<any, (db.TimestampTzString | Date) | db.Parameter<(db.TimestampTzString | Date)> | null | db.DefaultType | db.SQLFragment>;
      /**
      * **sessions.session_token**
      * - `uuid` in database
      * - `NOT NULL`, default: `gen_random_uuid()`
  ...
  export namespace verification_tokens {
    ...
    export interface Selectable {
      /**
      * **verification_tokens.property_id**
      * - `uuid` in database
      * - `NOT NULL`, no default
      */
      property_id: string;
